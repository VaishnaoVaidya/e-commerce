...
const HomeScreen = () => {
  ...
  const fetchAddresses = async ()=> {
    try {
      const response = await axios.get(`http://192.168.196.183:8000/addresses/${userId}`)
    ...
    <>
          ...
          <Pressable
            ...
            <Pressable>
              <Text
                ...
                Deliver to Vaishno - Mehkar 443301
              </Text>
            </Pressable>
            <Image
      ...
      <BottomModal
        ...
        <ModalContent style={{width: "100%", height: 400}}>
          ...
          <View style={{flexDirection: "column", marginBottom: 20, gap: 5}}>
